                ...
                <div className="services__content">
                    ...
                    <div className={toggleState === 1 ? "services__modal active__modal" : "services__modal"}>
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">I create webpage using both front-end and back-end development using  MERN stack.</p>
                ...
                <div className="services__content">
                    ...
                    <div className={toggleState === 3 ? "services__modal active__modal" : "services__modal"}>
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">I create beautiful interfaces with simple HTML,CSS & Javascript and also frameworks like ReactJS</p>
